...
import { Circle, EllipsisVertical, Sparkles } from 'lucide-react'
...
const EachComment = (props: Props) => {
  ...
  return (
    <div  className="border p-4 shadow-md rounded-2xl bg-gradient-to-b dark:from-neutral-900 via-neutral-600 dark:to-neutral-950 dark:text-white">
        ...
        <p className="col-span-10 dark:text-neutral-300">{props.ai_reply}</p>
        <div className="flex items-center space-x-5 mt-3">
            ...
            <Select>
              ...
              <SelectContent>
                ...
                <SelectItem value="hide_user">Hide User</SelectItem>
                <SelectItem value="report_spam">Report Spam</SelectItem>
              </SelectContent>
            </Select>
        </div>
        </div>
